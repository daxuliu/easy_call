...
public class SwitchButton extends View implements Checkable {
    ...
    protected void drawNumber(Canvas canvas,String num) {
        drawNumber(canvas,
                viewState.checkedLineColor,
                checkLineWidth,
                left + viewRadius - checkedLineOffsetX, centerY - checkLineLength,
...
//                uncheckCircleRadius,
//                paint);
        drawNumber(canvas,0xff000000,0,0,0,right-uncheckCircleOffsetX,centerY,paint,"0");
    }
